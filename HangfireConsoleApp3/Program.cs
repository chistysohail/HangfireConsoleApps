...
namespace HangfireConsoleApp3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            RecurringJob.AddOrUpdate("recurring-job3", () => JobProcessorLib.JobProcessor.ProcessJob(3, Environment.MachineName, connectionString), "*/5 * * * *");
        ...
        {
            BackgroundJob.Enqueue(() => JobProcessorLib.JobProcessor.ProcessJob(3, Environment.MachineName, connectionString));
        }
    }
}
